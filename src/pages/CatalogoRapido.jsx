        ...
        <div className="max-w-3xl mx-auto flex flex-col gap-4">
          ...
          <div className="flex justify-between items-center mb-1">
            ...
            <a 
              ...
              className="flex items-center gap-1.5 bg-[#25D366]/10 text-[#25D366] px-3 py-1.5 rounded-full border border-[#fafafa]/90 hover:bg-[#25D366]/20 transition-colors shadow-sm"
            >
